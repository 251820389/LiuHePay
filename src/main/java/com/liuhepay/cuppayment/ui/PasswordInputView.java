package com.liuhepay.cuppayment.ui;
...
public class PasswordInputView extends EditText {
    ...
    public PasswordInputView(Context context, AttributeSet attrs) {
        super(context, attrs);
        Log.i("pwd","构造方法的执行");
        DisplayMetrics dm = getResources().getDisplayMetrics();//获取屏幕分辨率信息
        borderWidth = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_SP, borderWidth, dm);//sp---->px
